...
<html lang="pt-BR">
  ...
  <body class="app-loading">
    ...
    <main class="app-shell" aria-label="SimpleGym">
      <div class="mobile-app">
        ...
        <header class="topbar">
          ...
          <a class="brand" aria-label="SimpleGym, início">Simple<span>Gym</span></a>
        ...
        <section class="page" id="perfil" data-page="profile">
          ...
          <section class="settings-block"><p class="micro-title">CONFIGURAÇÕES</p><div class="setting-list"><button data-action="appearance"><span class="setting-icon blue"><i data-lucide="palette"></i></span><span><strong>Aparência</strong><small id="appearance-current">Tema escuro</small></span><i data-lucide="chevron-right"></i></button><button data-action="privacy"><span class="setting-icon gray"><i data-lucide="shield-check"></i></span><span><strong>Privacidade e dados</strong><small>Gerencie suas informações</small></span><i data-lucide="chevron-right"></i></button><button data-action="terms"><span class="setting-icon gray"><i data-lucide="file-text"></i></span><span><strong>Termo de responsabilidade</strong><small>Riscos, cuidados e condições de uso</small></span><i data-lucide="chevron-right"></i></button></div></section>
    ...
    <script src="assets/js/app.js?v=20260917-conta"></script>
  </body>
</html>
